...
//
//  UIView * rootView = [[RCTRootView alloc]initWithBundleURL:jsCodeLocation moduleName:@"YNCircleInputView" initialProperties:nil launchOptions:nil];
//
//  UIViewController * rnPageVc = [[UIViewController alloc]init];
//  rnPageVc.view = rootView;
//  [[AppDelegate sharedAppDelegate] pushViewController:rnPageVc withBackTitle:@"返回"];
