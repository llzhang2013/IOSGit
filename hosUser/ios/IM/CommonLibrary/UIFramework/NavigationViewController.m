...
-(UIBarButtonItem *)backItem{
 ...
 return  [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"back"] style:UIBarButtonItemStylePlain target:self action:@selector(onLeftItem)];
...
- (void)setNavigationBarAppearance
{
  ...
  [self.navigationBar setBarTintColor:UIColorFromHex(0x3EB6F2)];
