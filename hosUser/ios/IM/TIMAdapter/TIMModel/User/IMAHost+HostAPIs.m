...
//zll修改new
- (void)asyncSetHeadImage:(NSString *)faceURL  succ:(TIMSucc)succ fail:(TIMFail)fail
{
  if ([NSString isEmpty:faceURL])
  {
    [[HUDHelper sharedInstance] tipMessage:@"头像不能为空"];
    return;
  }
